              ...
              <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-4">
                <div className="grid gap-4 sm:grid-cols-2">
                  <div>
                    ...
                    />
                    {errors.name && (
                      <p className="mt-1 text-xs text-error">{f('name')} zorunludur.</p>
                    )}
                  </div>
                  <div>
                    ...
                    />
                    {errors.lastName && (
                      <p className="mt-1 text-xs text-error">{f('lastName')} zorunludur.</p>
                    )}
                  </div>
                </div>
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                  <div>
                    ...
                    />
                    {errors.phoneNumber && (
                      <p className="mt-1 text-xs text-error">{f('phoneNumber')} zorunludur.</p>
                    )}
                  </div>
                  <div>
                    ...
                    />
                    {errors.email && (
                      <p className="mt-1 text-xs text-error">{f('email')} geçersiz.</p>
                    )}
                  </div>
                </div>
                ...
                <div>
                  ...
                  />
                  {errors.description && (
                    <p className="mt-1 text-xs text-error">{f('message')} zorunludur.</p>
                  )}
                </div>
